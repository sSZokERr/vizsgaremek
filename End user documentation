...
3.1 The main page
The main page contains two main functions on the webpage.
...
3.2 Home page
After a successful login the user will be redirected to the home page. Here the user can see other artists previously made projects. 
The user can click on any project and will see the the full details about it, every picture title and a description about it.

3.3 The profile page
The profile menu can be accessed from the side menu bar as every function in the application.
...
The brief introduction can be changed by clicking on the Edit profile button. This creates input fields that can be edited.
After giving the desired information, save could be done by pressing the Save button which will save the profile details.
...
3.4 New Project
The project creation page can be accessed by clicking on the New Project option in the side menu. This will redirect the user to a blank project template that can be filled with content.
...
Once completed, the project can be saved by clicking the submit button at the bottom of the page. This will redirect the user to the home page after a few seconds.
